...
//        std::cout << "Searching segment " << parent.getId() << ", depth=" << depth
//                  << ", #children=" << parent.children.size() << std::endl;
...
//                std::cout << "bad = " << bad << std::endl;
                ...
                if (!bad) {
                    ...
                    if (d0 < Quad::minimumEdgeLength || d1 < Quad::minimumEdgeLength || d2 < Quad::minimumEdgeLength ||
                        ...
                        bad = true;
//                        std::cout << "tagsize too small" << std::endl;
                    }
                    ...
                    if (dmax > dmin * Quad::maxQuadAspectRatio) {
                        bad = true;
//                        std::cout << "aspect ratio too extreme" << std::endl;
                    }
                }
...
//                std::cout << "theta failed: " << child.getTheta() << " > " << path[0]->getTheta() << std::endl;
                continue;
            }
            path[depth + 1] = &child;
