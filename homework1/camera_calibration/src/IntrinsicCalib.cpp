...
int main(int argc, char** argv)
{
    ...
    std::string apriltag_flag = "false";
    ...
    desc.add_options()
        ...
        ("apriltag,a", boost::program_options::value<std::string>(&apriltag_flag)->default_value("false"), "use apriltag as target true | false")
        ;
