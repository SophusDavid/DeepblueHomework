...
int main(int argc, char **argv){
    ...
    std::cout << "E gt norm"<<std::endl<<E_gt.norm()<<std::endl;
    std::cout << "E gt "<<std::endl<<E_gt<<std::endl;
    std::cout << std::endl;
    std::cout << "E norm"<<std::endl<<E.norm()<<std::endl;
    std::cout << "E  "<<std::endl<<E<<std::endl;

    std::cout << std::endl;
    std::cout << "E_rescale norm"<<std::endl<<E.norm()/(E.norm()/E_gt.norm())<<std::endl;
    std::cout << "E_rescale  "<<std::endl<<E/(E.norm()/E_gt.norm())<<std::endl;
